 ...
 */
declare function PaperInputBehavior<T extends new (...args: any[]) => {}>(base: T): T & PaperInputBehaviorConstructor;

interface PaperInputBehaviorConstructor {
  new(...args: any[]): PaperInputBehavior;
}

export {PaperInputBehaviorConstructor};
...
interface PaperInputBehavior {
   ...
   */
  _focusBlurHandler(event: Event|null): void;
